 ...
 * @author venot
 */
public class IngresaCedula extends javax.swing.JInternalFrame {
     ...
     */
    public IngresaCedula(JTable jTableClientes) {
        initComponents();
    ...
    public void addClienteToTable(Empleado empleado) {
        DefaultTableModel model = (DefaultTableModel) jTableClientes.getModel();
        model.addRow(new Object[]{empleado.getCedula(), empleado.getNombre(), empleado.getApellido(), empleado.getDireccion(), empleado.getTelefono(), empleado.getCorreo(),empleado.getContrasenia()});
    }
    ...
    public Empleado getVentanaCedula(){
        return empleado;
    }
